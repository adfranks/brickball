...
<body>
  ...
  <div id="container">
    ...
    try {
        ...
        if ($row == null) {
            echo '<div class="form-response"><span class="errormsg">Invalid password.  Please try again.</span>
        ...
        echo '<p class="form-response"><span class="errorsmg">Oopsy Daisy!  Error: ' . $e->getMessage() . 
        '</span><a class="error-link" href="brickball.php">Go back and play the game</a>.</p>';
    }
