...
<body>
  ...
  <div id="container">
    ...
    $msg = "<html><head><title>Reset Password</title></head>
            <body><p>If you requested to reset your password, please click on 
            the link within the hour:  " . $url . "</p>
    ...
    try {
        ...
        $sql = $conn->prepare("UPDATE members SET token='" . $token . "',
               expiration='" . $expiry . "' WHERE email='" . $email . "'");
        $sql->execute();
        ...
        echo '<p class="form-response">A message was just sent to your email 
              address.  Within the hour, open the message and click on
              the provided link to reset your password.</p>';
