...
$msg = "<html><head><title>Reset Password</title></head><body style='font-size:150%;'><p>If you requested to reset your password, please click on the link: " . $url . "</p><p>Otherwise, feel free to ignore this message.<br />Brickball</p></body></html>"; 
