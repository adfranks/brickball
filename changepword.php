  ...
  <div id="container">
    ...
    if ($_SESSION['pword'] == md5($_POST['currentpsw'])) {
        try {
            ...
            echo '<p class="form-response">Password successfully changed!<br /><br />
        ...
        echo '<span class="errormsg">The current password entered is incorrect.  Please, try again.</span>
